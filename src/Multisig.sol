...
/**
 * @title MultiSig
 * @author Jay - lelerukjaymoh@gmail.com
 *
 * Multi-Signature Wallet.
 * Allows multiple parties to agree on transactions before execution.
 * Adapted from dydx's MultiSigWallet contract.
 *
 * Logic Changes:
 *  - Removed the fallback function
 *  - Ensure newOwner is notNull
 *  - Update the contract to use v0.8.13
 *
 * Syntax Changes:
 ...
 *
 *  - Updated the code to support v0.8.13
 */
contract MultiSig {
    // ============ Events ============
    ...
    function removeOwner(address owner) public onlyWallet ownerExists(owner) {
        ...
        // Since solidity version v6.0 you cannot resize an array value using array.length
